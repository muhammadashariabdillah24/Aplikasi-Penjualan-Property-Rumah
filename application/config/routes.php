...
$route['ar_d/(:any)']        = 'web/artikel_detail/$1';
// $route['ar_d/(:any)/(:any)'] = 'web/artikel_detail/$1/$2';

$route['produk']             = 'web/barang';
$route['produk/(:any)']      = 'web/barang/$1';
$route['dtl/(:any)']         = 'web/barang_detail/$1';

$route['about']              = 'web/profile';
$route['help']               = 'web/kontak';
